...
$this->title = "Home - Heal it up"
?>

<div class = "row" style="height:100vh">
        <div class = "col-md-6">
            <h1 id = "title"> Heal it up</h1>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" >
        <div class="item active">
            <img src="<?php echo Yii::$app->request->baseUrl; ?>/images/cleanup-drive1.jpg" alt="image1">
        </div>

        <div class="item">
        <img src="<?php echo Yii::$app->request->baseUrl; ?>/images/cleanup-drive2.jpg" alt="image2">
        </div>
